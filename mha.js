questions = [
	...
	},
    {
     ...
     {
		question: "Do you frequently feel bothered by not being able to stop worrying ?",
		optionA: { text: "always", pointsforopt: 0, correct: false },
		optionB: { text: "mostly", pointsforopt: 1, correct: false },
		optionC: { text: "sometimes", pointsforopt: 2, correct: false },
		optionD: { text: "no", pointsforopt: 3, correct: true },
     ...
     {
		question: "Over the past few weeks, have you often felt the future was bleak ?",
		optionA: { text: "always", pointsforopt: 0, correct: false },
		optionB: { text: "mostly", pointsforopt: 1, correct: false },
		optionC: { text: "sometimes", pointsforopt: 2, correct: false },
		optionD: { text: "no", pointsforopt: 3, correct: true },
    ...
    {
		question: " Do you often get sudden mood swings or extreme emotions ?",
		optionA: { text: "always", pointsforopt: 0, correct: false },
		optionB: { text: "mostly", pointsforopt: 1, correct: false },
		optionC: { text: "sometimes", pointsforopt: 2, correct: false },
		optionD: { text: "no", pointsforopt: 3, correct: true },
...
function handleEndGame() {
	...
	else if (playerScore >= 9 && playerScore < 18) {
	...
	else if (playerScore >= 18 && playerScore < 21) {
